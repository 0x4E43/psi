              ...
              >
                <div className="flex flex-col justify-between p-4 leading-normal">
                  ...
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    We help you leverage a comprehensive platform for your
                    investment prospectus, registration statements, mutual fund
                    reporting, shareholder reports, fund books, fund financial
                    statements, and SEC filings, including Forms N-PORT and
                    N-CEN.
                  </p>
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    PsiKnowLogix enables your team to replace manual processes
                    and eliminate the security risk of using desktop
                    spreadsheets for managing reports for mutual funds and
                    insurance, as well as private equity and alternative
                    investments.
                  </p>
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    Our process connects source of data for annual and
                    semiannual shareholder reports, fund books, fund financial
                    statements, and other required investment reports and
                    filings for private and public investment firms, thereby
                    significantly reducing the time required to develop the
                    final outputs.
                  </p>
                </div>
                <Image
