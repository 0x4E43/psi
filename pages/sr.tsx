              ...
              >
                <div className="flex flex-col justify-between p-4 leading-normal">
                  ...
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    SEDAR is the System for Electronic Document Analysis and
                    Retrieval, the electronic filing system for the disclosure
                    documents of public companies and mutual funds across
                    Canada.
                  </p>
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    All Canadian public companies and mutual funds are generally
                    required to file their documents in the SEDAR system. In
                    addition, some OTC issuers with ties to British Columbia and
                    third parties who are involved in public company
                    transactions such as take-over bids or proxy contests may be
                    required to report.
                  </p>
                  <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">
                    We help you make sense of your financial statements to
                    determine the financial position of your enterprise. We also
                    use accurate and relevant collated data to evaluate your
                    business performance. We help decision-makers to make better
                    choices in terms of strategizing and profitability. <br /> As a
                    SEDAR filing agent PsiKnowLogix has been providing SEDAR
                    filing services to multiple companies throughout Canada.
                  </p>
                </div>
                <Image
